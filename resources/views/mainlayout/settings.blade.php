	...
	<div class="hk-settings-panel">
            <div class="nicescroll-bar position-relative">
                <div class="settings-panel-wrap">
                    <div class="settings-panel-head">
                        <img class="brand-img d-inline-block align-top" src="{{env('APP_URL')}}uploads/static/1xLogosmall.png" height="30px" alt="brand" />
                    ...
                    <div class="layout-img-wrap">
                        <div class="row">
                            <a href="javascript:void(0);" class="col-6 mb-30 active">
                                <img class="rounded opacity-70" src="{{env('APP_URL')}}dist/img/layout1.png" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                          <!--   <a href="dashboard2.html" class="col-6 mb-30">
                                <img class="rounded opacity-70" src="{{env('APP_URL')}}dist/img/layout2.png" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                            <a href="dashboard3.html" class="col-6">
                                <img class="rounded opacity-70" src="{{env('APP_URL')}}dist/img/layout3.png" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a> -->
                        </div>
                    </div>
            ...
            <img class="d-none" src="{{env('APP_URL')}}uploads/static/1xLogosmall.png" alt="JTMB" />
            <img class="d-none" src="{{env('APP_URL')}}uploads/static/1xLogosmall.png" alt="JTMB" />
        </div>